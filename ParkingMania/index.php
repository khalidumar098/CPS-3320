    ...
    <div class="container-fluid" id= "title"> 
      ...
      <div class="row">
        ...
        <div class="col-lg-12 animated fadeInUp">
          <h1 class="heading"><br/>We have the cheapest prices in EWR. Thank you for giving us the opportunity to serve you. If you have any questions go to the Contact page.<br/></h1>
          
          <h4><br/>Download the Parking Mania App, it's simple, and easy to manage your account.<br/></h4>
