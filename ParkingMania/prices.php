      ...
      <div class="pricing-column col-lg-4 col-md-6 animated fadeIn2">
        <div class="card animated pulse">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-lg btn-block btn-dark" type="button" id="register1">Reserve</button>
      ...
      <div class="pricing-column col-lg-4 col-md-6 animated fadeIn3">
        <div class="card animated pulse2">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-lg btn-block btn-dark" type="button" id="register2">Reserve</button>
            <script type="text/javascript">
      ...
      <div class="pricing-column col-lg-4 animated fadeIn4">
        <div class="card animated pulse3">
          ...
          <div class="card-body">
            ...
            <p>Interior Vacuum</p>
            <p>Valet Parking</p>
            <button class="btn btn-lg btn-block btn-dark" type="button" id="register3">Reserve</button>
            <script type="text/javascript">
